      ...
      <section class="col-lg-6 col-lg-offset-3">       
        <div class="box box-info">
          ...
          <div class="box-header">
            ...
            <a href="admin.php" class="btn btn-info btn-sm pull-right"><i class="fa fa-reply"></i> &nbsp; Back</a> 
          </div>
          <div class="box-body">
            <form action="admin_update.php" method="post" enctype="multipart/form-data">
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="password" min="5" placeholder="Empty if you don't want to replace it">
                  <small class="text-muted">Empty if you don't want to replace it</small>
                </div>
