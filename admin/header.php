...
<head>
  ...
  <title>Dashboard Admin - Electronics Online Store</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        <span class="logo-mini"><b>E - </b>STORE\</span>
    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          <li class="header">ADMIN TASK NAVIGATION</li>
          ...
          <li>
            <a href="kategori.php">
              <i class="fa fa-folder"></i> <span>DATA CATEGORY</span>
            </a>
          </li>

          <li>
            <a href="produk.php">
              <i class="fa fa-gift"></i> <span>DATA PRODUCT</span>
            </a>
          </li>
          ...
          <li>
           ...
           <li>
            <a href="transaksi.php">
              <i class="fa fa-retweet"></i> <span>TRANSACTIONS / ORDERS</span>
            </a>
          </li>
