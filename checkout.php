							...
							<div class="col-lg-6">
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<h4 class="text-center">CUSTOMER/RECIPIENT INFORMATION</h4>

										<div class="form-group">
											<label>Name</label>
											<input type="text" class="input" name="nama" placeholder="Enter the order name.." required="required">
										</div>

										<div class="form-group">
											<label>No. HP</label>
											<input type="number" class="input" name="hp" placeholder="Enter an active hp number.." required="required">
										</div>

										<div class="form-group">
											<label>Address</label>
											<textarea name="alamat" class="form-control" style="resize: none;" rows="6" placeholder="Enter complete address.."></textarea>
										</div>
										...
										<div class="form-group">
											...
											<select name='provinsi' id='provinsi' class="input">
												<option>Select Destination Province</option>
												<?php 
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="pull-left">
											<a class="main-btn" href="keranjang.php">Back To Cart</a>
										</div>

										<div class="pull-right">
											<input type="submit" class="primary-btn" value="Make an Order">
										</div>
									</div>
								</div>
							...
							<div class="col-lg-6">
								...
								if(isset($_SESSION['keranjang'])){
									...
									if($jumlah_isi_keranjang != 0){
										...
										echo "<br><br><br><h3><center>Cart Still Empty. Let's go <a href='index.php'>Shopping</a> !</center></h3><br><br><br>";
									}
