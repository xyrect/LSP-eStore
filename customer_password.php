						...
						<div class="col-lg-12">
							...
							<form action="customer_password_act.php" method="post">
								<div class="form-group">
									...
									<input type="password" class="input" required="required" name="password" placeholder="Enter password .." min="5">
								</div>

								<div class="form-group">
									<input type="submit" class="primary-btn" value="Change Password">
								</div>
							</form>
						</div>
