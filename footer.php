		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<div class="footer-logo">
						<a class="logo" href="#">
						<img src="frontend/img/logo1.png">

						</a>
					</div>
					<!-- /footer logo -->

					<p>Online shop providing cheap electronic goods with good and reliable quality.</p>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<p>Follow our social media to get closer and get the latest information about our store.</p>
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2 text-center">
				...
				<div class="footer-copyright">
					...
					Copyright &copy;<script>document.write(new Date().getFullYear());</script> Electronics Store
