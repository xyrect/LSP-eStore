...
<head>
	...
	<title>BEST ELECTRONIC ONLINE STORE</title>
				...
				<div class="pull-left">
					...
					<div class="header-search">
						<form action="" method="get">
							<input class="input" type="text" name="cari" placeholder=" search ...">
							...
							<div class="custom-menu">
								<div id="shopping-cart">
									...
									<div class="shopping-cart-btns">
										<a class="main-btn" href="keranjang.php">Shopping Cart</a>
						...
						if(isset($_SESSION['customer_status'])){
							...
							<li class="header-account dropdown default-dropdown" style="min-width: 200px">
								...
								<ul class="custom-menu">
									<li><a href="customer.php"><i class="fa fa-user-o"></i> My Account</a></li>
									<li><a href="customer_pesanan.php"><i class="fa fa-list"></i> My Order</a></li>
									<li><a href="customer_password.php"><i class="fa fa-lock"></i> Change Password</a></li>
							...
							<li class="header-account dropdown default-dropdown">
								...
								<a href="daftar.php" class="text-uppercase primary-btn">Register</a> 
							</li>
							<?php
						}
						?>
		...
		<div class="container">
			<div id="responsive-nav">
				...
				<div class="category-nav show-on-click">
					<span class="category-header">Product Category <i class="fa fa-list"></i></span>
					<ul class="category-list">
						...
						?>
						<li style="background: #999;"><a href="index.php" style="color: white">Show All</a></li>
					</ul>
				</div>
				<!-- /category nav -->
