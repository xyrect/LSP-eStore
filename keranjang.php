				...
				<form method="post" action="keranjang_update.php">
					<div class="order-summary clearfix">
						<div class="section-title">
							<h3 class="title">Fill the Shopping Cart</h3>
						</div>

						<?php 
						if(isset($_GET['alert'])){
							if($_GET['alert'] == "keranjang_kosong"){
								echo "<div class='alert alert-danger text-center'>Cannot check out, because the shopping cart is still empty. <br/> Please shop first :).</div>";
							}
						}
						?>
