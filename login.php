  ...
  <div class="container">
    <div class="login-box">
      ...
      <center>
        ...
        if(isset($_GET['alert'])){
          if($_GET['alert'] == "gagal"){
            echo "<div class='alert alert-danger'>Login failed! username and password are incorrect!</div>";
          }else if($_GET['alert'] == "logout"){
            echo "<div class='alert alert-success'>You have successfully logged out</div>";
          }else if($_GET['alert'] == "belum_login"){
            echo "<div class='alert alert-warning'>You must be logged in to access the admin page.</div>";
          }
        }
        ?>
      </center>
