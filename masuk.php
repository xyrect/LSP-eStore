				...
				<div class="order-summary clearfix">
					...
					if(isset($_GET['alert'])){
						if($_GET['alert'] == "terdaftar"){
							...
							echo "<div class='alert alert-warning text-center'>Please login first to make an order.</div>";
						}
					}
					?>
						...
						<div class="col-lg-6 col-lg-offset-3">
							...
							<form action="masuk_act.php" method="post">
								...
								<div class="form-group">
									...
									<input type="password" class="input" required="required" name="password" placeholder="your password">
								</div>

								<div class="form-group">
									<input type="submit" class="primary-btn btn-block" value="Login">
									<a href="daftar.php" class="main-btn btn-block text-center">Register</a>
								</div>
							</form>
