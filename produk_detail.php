					...
					<div class="col-md-6">
						<div class="product-body">
							<div class="product-label">
								...
								<span class="sale">Best Quality</span>
							</div>
							<br>
							...
							<form action="">
								<div class="product-btns">
									...
									<a class="primary-btn add-to-cart" href="keranjang_masukkan.php?id=<?php echo $d['produk_id']; ?>&redirect=detail"><i class="fa fa-shopping-cart"></i> ADD TO CART</a>
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="section-title">
					<h2 class="title">Other Product Recommendations</h2>
				</div>
			</div>
			<!-- section title -->
					...
					<div class="product product-single">
						...
						<div class="product-body">
							...
							<div class="product-btns">
								...
								<a class="primary-btn add-to-cart btn-block text-center" href="keranjang_masukkan.php?id=<?php echo $d['produk_id']; ?>&redirect=detail"><i class="fa fa-shopping-cart"></i> ADD TO CART</a>
							</div>
						</div>
					</div>
				</div>
