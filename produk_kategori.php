	...
	<div class="container">
		...
		<div class="row">
			...
			<div id="main" class="col-md-12">
				...
				<div class="pull-left">
					<h4>Product Category : <?php echo $k['kategori_nama']; ?></h4>
				</div>
						...
						<div class="pull-right">
							<div class="sort-filter">
								...
								<select class="input" name="urutan" onchange="this.form.submit()">
									<option <?php if(isset($_GET['urutan']) && $_GET['urutan'] == "terbaru"){echo "selected='selected'";} ?> value="terbaru">Latest</option>
									<option <?php if(isset($_GET['urutan']) && $_GET['urutan'] == "harga"){echo "selected='selected'";} ?> value="harga">Price</option>
								</select>
							</div>
						</div>
					</div>
				...
				<div id="store">
					...
					<div class="row">
							...
							<div class="col-md-3 col-sm-6 col-xs-6">
								<div class="product product-single">
									...
									<div class="product-body">
										<h3 class="product-price"><?php echo "Rp. ".number_format($d['produk_harga']).",-"; ?> <?php if($d['produk_jumlah'] == 0){?> <del class="product-old-price">Empty</del> <?php } ?></h3>
										...
										<div class="product-btns">
											...
											<a class="primary-btn add-to-cart btn-block text-center" href="keranjang_masukkan.php?id=<?php echo $d['produk_id']; ?>&redirect=index"><i class="fa fa-shopping-cart"></i> ADD TO CART</a>
										</div>
									</div>
								</div>
							</div>
						...
						if(mysqli_num_rows($data) == 0){
							echo "<center><h3>Product Not Available Yet</h3></center>";
						}
						?>
